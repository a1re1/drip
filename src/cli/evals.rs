...
fn builtin_eval_entries() -> Vec<(&'static str, &'static str, &'static str)> {
    vec![
        builtin_case!("address-review-findings-plan"),
        builtin_case!("bevy-hello-world-plan"),
        builtin_case!("bootstrap-proxy-plan"),
        builtin_case!("build-treenotes-cli-plan"),
        ...
        builtin_case!("finish-partial-patch-plan"),
        builtin_case!("finish-praeparare-plan"),
        builtin_case!("finish-wiring-glass-plan"),
        builtin_case!("flaky-test-fixup"),
        builtin_case!("git-only-commit-plan"),
        builtin_case!("git-precommit-hook"),
        builtin_case!("hanging-test-suite-plan"),
        builtin_case!("layad-400-errors-plan"),
        builtin_case!("list-open-prs"),
        builtin_case!("mcp-client-per-role-plan"),
        builtin_case!("mutex-vs-rwlock"),
        builtin_case!("one-bash-verbatim-plan"),
        builtin_case!("paste-diff-verbatim-plan"),
        builtin_case!("pattern-migration"),
        builtin_case!("plan-for-approval-plan"),
        builtin_case!("port-check-tool-plan"),
        builtin_case!("port-session-layer-plan"),
        builtin_case!("port-wait-ts-plan"),
        builtin_case!("prepare-draft-pr"),
        builtin_case!("rebase-and-force-push"),
        builtin_case!("recon-reward-code-plan"),
        builtin_case!("remove-notes-page-plan"),
        builtin_case!("remove-provisioning-plan"),
        builtin_case!("remove-reward-scoring-plan"),
        builtin_case!("rename-command-fails-plan"),
        builtin_case!("rename-for-clarity"),
        builtin_case!("rename-skills-to-stools-plan"),
        builtin_case!("review-finished-task"),
        builtin_case!("review-pr-diff"),
        builtin_case!("scrub-ts-mentions-plan"),
        builtin_case!("session-end-notification"),
        builtin_case!("ship-this-branch"),
        builtin_case!("skill-slash-autoload-plan"),
        builtin_case!("skills-picker-to-pr-plan"),
        builtin_case!("split-large-module"),
        builtin_case!("startup-panic"),
        builtin_case!("summarize-open-prs-plan"),
        builtin_case!("targeted-review-fixes-plan"),
        builtin_case!("treenotes-read-error-plan"),
        builtin_case!("tune-classifier"),
        builtin_case!("two-p1-findings-plan"),
        builtin_case!("underspecified-auth-plan"),
        builtin_case!("up-arrow-history-plan"),
        builtin_case!("verify-activity-charts-plan"),
        builtin_case!("verify-flow-pill-plan"),
        builtin_case!("verify-treenotes-plan"),
        builtin_case!("what-does-flag-do"),
        builtin_case!("what-does-repo-do-plan"),
        builtin_case!("whats-in-repo-plan"),
    ]
}
